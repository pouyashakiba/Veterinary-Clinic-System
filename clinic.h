...
//sorting a data in a array of structs based on their time order
void sort(struct ClinicData* sorted);

// Get user input for date of appointment
void inputDate(struct Date* date);

//validating the entered time and check if it's full or not (returns 1 if valid)
